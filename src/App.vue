  ...
  <body>
    ...
    <main>
      ...
      <div class="service">
        ...
        <div class="service-content" v-for="(item, index) in serviceContent" :key="index">
          <div class="service-img" :class="{'service-img_second' :item.leftSide}">
            <img :src="item.serviceImg" alt="" />
          </div>
          <div class="service-content_inner" :class="{'service-content_inner-second' :item.leftSide}">
            <h3 class="mgb-15">{{item.serviceTitle}}</h3>
            <p class="mgb-15">{{item.serviceMission}}</p>
            <p class="mgb-15">
...
export default {
  data() {
    return {
      news: {
        date: "2019/01/01",
        title: "ニュースタイトルがここには入ります。3月の決算報告書"
      },
      serviceContent: [
        { serviceImg: require("./assets/service2.jpg"),
          serviceTitle: "web制作事業",
          serviceMission: "コーチングのミッション",
          serviceDescription: "ユーザーが求める物を分析し、ユーザビリティを備えた最適なサイトを提供。建設業から美容、ブライダル、飲食店まで多種多様な業種の制作実績があります",
          href: "",
          leftSide: false,
        },
        { serviceImg: require("./assets/service1.jpg"),
          serviceTitle: "web制作事業",
          serviceMission: "コーチングのミッション",
          serviceDescription: "ユーザーが求める物を分析し、ユーザビリティを備えた最適なサイトを提供。建設業から美容、ブライダル、飲食店まで多種多様な業種の制作実績があります",
          serviceHref: "",
